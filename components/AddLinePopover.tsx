...
export function AddLinePopover ({ uuid }: { uuid: string }) {
  ...
  return (
    <Tooltip id={`add-line-${uuid}`} place="left" className="z-50" clickable
      ...
      render={({ content }) => {
        ...
        return (
          <div className="z-50 flex flex-col gap-2 cursor-pointer" onMouseOverCapture={(e) => {
            ...
            <div className="px-2 hover:text-green-400 hover:border-green-400" title="Add line" onClick={() => handleAddLine(false, contentObject.prepend)}><PlusIcon /></div>
