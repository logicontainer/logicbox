...
object Diagnostic {
  ...
  case class ReferenceIdNotFound[Id](stepId: Id, refIdx: Int, refId: Id) extends Diagnostic[Id]
  case class MalformedReference[Id](stepId: Id, refIdx: Int, refId: Id, expl: String) extends Diagnostic[Id]
