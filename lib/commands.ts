...
export class AddLineCommand extends Command {
  ...
  undo(proofContext: ProofContextProps): ServerCommand[] {
    ...
    return [new RemoveStepServerCommand(this.newLineUuid)];
  }
...
export class AddBoxedLineCommand extends Command {
  ...
  undo(proofContext: ProofContextProps): ServerCommand[] {
    ...
    return [new RemoveStepServerCommand(this.newBoxUuid)];
  }
  getDescription(): string {
...
export class RemoveProofStepCommand extends Command {
  ...
  execute(proofContext: ProofContextProps): ServerCommand[] {
    ...
    return [new RemoveStepServerCommand(this.proofStepUuid)];
  }
  ...
  undo(proofContext: ProofContextProps): ServerCommand[] {
    ...
    return [
      new InitLineServerCommand(
        ...
        this.position.nearProofStepWithUuid,
        this.position.prepend ? "before" : "after",
      ), // TODO: Should be init subtree or something. This needs a lot of recursive init line and update line commands
    ];
  }
  getDescription(): string {
...
export class UpdateLineProofStepCommand extends Command {
  ...
  execute(proofContext: ProofContextProps): ServerCommand[] {
    ...
    return [
      new UpdateLineServerCommand(
        this.proofStepUuid,
        this.updatedLineProofStep.formula,
        this.updatedLineProofStep.justification.ruleName,
        this.updatedLineProofStep.justification.refs,
      ),
    ];
  }
  ...
  undo(proofContext: ProofContextProps): ServerCommand[] {
    ...
    return [
      new UpdateLineServerCommand(
        this.proofStepUuid,
        this.prevProofStep.formula,
        this.prevProofStep.justification.ruleName,
        this.prevProofStep.justification.refs,
      ),
    ];
  }
  getDescription(): string {
